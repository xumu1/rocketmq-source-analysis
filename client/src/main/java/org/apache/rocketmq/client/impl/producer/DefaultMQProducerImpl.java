...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private final BlockingQueue<Runnable> asyncSenderThreadPoolQueue;  // 异步发送的队列
    private final ExecutorService defaultAsyncSenderExecutor;  // 异步发送的线程池
